...
class DecisionStump extends WeightedClassifier
{
     ...
     */
    public function __construct($columnIndex = self::AUTO_SELECT)
    {
     ...
     * @param float $count
     */
    public function setNumericalSplitCount($count)
    {
     ...
     * @return array
     */
    protected function getBestNumericalSplit(array $samples, array $targets, $col)
    {
     ...
     * @return array
     */
    protected function getBestNominalSplit(array $samples, array $targets, $col)
    {
        $values = array_column($samples, $col);
     ...
     * @return array
     */
    protected function calculateErrorRate(array $targets, $threshold, $operator, array $values)
    {
        $wrong = 0.0;
        $prob = [];
