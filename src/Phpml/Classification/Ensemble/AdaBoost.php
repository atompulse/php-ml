...
class AdaBoost implements Classifier
{
     ...
     *
     */
    public function __construct($maxIterations = 50)
    {
     ...
     */
    public function setBaseClassifier($baseClassifier = DecisionStump::class, array $classifierOptions = [])
    {
     ...
     * @return float
     */
    protected function calculateAlpha($errorRate)
    {
        if ($errorRate == 0) {
            $errorRate = 1.0E-10;
        }
     ...
     * @param float $alpha
     */
    protected function updateWeights(Classifier $classifier, $alpha)
    {
