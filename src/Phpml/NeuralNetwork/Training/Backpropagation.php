...
class Backpropagation implements Training
{
     ...
     * @param int     $theta
     */
    public function __construct(Network $network, $theta = 1)
    {
     ...
     * @return int
     */
    private function trainSamples(array $samples, array $targets, $desiredError)
    {
     ...
     * @return float
     */
    private function getSigma(Neuron $neuron, array $target, $key, $lastLayer)
    {
     ...
     * @return bool
     */
    private function isResultWithinError(array $result, array $target, $desiredError)
    {
