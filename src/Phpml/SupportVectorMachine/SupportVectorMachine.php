...
class SupportVectorMachine
{
     ...
     */
    public function __construct($type, $kernel, $cost = 1.0, $nu = 0.5, $degree = 3, $gamma = null, $coef0 = 0.0, $epsilon = 0.1, $tolerance = 0.001, $cacheSize = 100, $shrinking = true, $probabilityEstimates = false)
    {
        $this->type = $type;
        $this->kernel = $kernel;
        $this->cost = $cost;
     ...
     * @return string
     */
    private function buildTrainCommand($trainingSetFileName, $modelFileName)
    {
