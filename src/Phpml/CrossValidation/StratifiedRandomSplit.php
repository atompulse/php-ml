...
class StratifiedRandomSplit extends RandomSplit
{
     ...
     */
    protected function splitDataset(Dataset $dataset, $testSize)
    {
     ...
     */
    private function splitByTarget(Dataset $dataset)
    {
     ...
     * @return array
     */
    private function createDatasets(array $uniqueTargets, array $split)
    {
        $datasets = [];
