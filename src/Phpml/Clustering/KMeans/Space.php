...
class Space extends SplObjectStorage
{
     ...
     */
    public function cluster($clustersNumber, $initMethod = KMeans::INIT_RANDOM)
    {
     ...
     * @return array|Cluster[]
     */
    protected function initializeClusters($clustersNumber, $initMethod)
    {
        switch ($initMethod) {
     ...
     * @return array
     */
    private function initializeRandomClusters($clustersNumber)
    {
        $clusters = [];
     ...
     * @return array
     */
    protected function initializeKMPPClusters($clustersNumber)
    {
        $clusters = [];
        $this->rewind();
